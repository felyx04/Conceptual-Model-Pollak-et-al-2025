...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 27 12:16:04 2024

@author: pollakf

Note: - Same as GRAD_jax_plot.py
...
# save_data = '../Data/GRAD_jax_2,6Myr.pkl'
save_data = None
...
def calc_bounds(time_steps):
    ...
    return (time_bounds, v0s, tauds, v0_bounds, v1_bounds)
...
v1 = StartPosition[10]
vi = StartPosition[11]
C_v0 = StartPosition[12]
C_taud = StartPosition[13]
...
time_bounds, v0s, tauds, v0_bounds, v1_bounds = calc_bounds(time_steps)
...
# plt.savefig('../Plots/GRAD_jax.png', dpi=500, bbox_inches='tight')
plt.show()
