...
class TOLcmaps(object):
    ...
    def __init__(self):
        ...
        self.cmap = None
        self.cname = None
        self.namelist = ( 'YlOrRd_discrete', 'YlOrRd', 'BrBG_discrete', 'BrBG',
        ...
        self.funcdict = dict(
            zip(self.namelist,
                (self.__YlOrRd_discrete, self.__YlOrRd,
                self.__BrBG_discrete, self.__BrBG,
    ...
    def __YlOrRd_discrete(self):
        """
        Define colormap 'BrBG_discrete'.
        """
        clrs = ['#ffffcc','#ffeda0','#fed976','#feb24c','#fd8d3c','#fc4e2a','#e31a1c','#bd0026','#800026']
        self.cmap = discretemap(self.cname, clrs)
        #self.cmap.set_bad('#FFEE99')
        self.cmap.set_bad(np.array([0., 0., 0., 0.]))
        
    def __YlOrRd(self):
        """
        Define colormap 'BrBG'.
        """
        clrs = ['#ffffcc','#ffeda0','#fed976','#feb24c','#fd8d3c','#fc4e2a','#e31a1c','#bd0026','#800026']
    ...
    def __BrBG_discrete(self):
        """
        Define colormap 'BrBG_discrete'.
        """
        clrs = ['#8c510a','#bf812d','#dfc27d','#f6e8c3','#f5f5f5','#c7eae5','#80cdc1','#35978f','#01665e']
        self.cmap = discretemap(self.cname, clrs)
        #self.cmap.set_bad('#FFEE99')
        self.cmap.set_bad(np.array([0., 0., 0., 0.]))
